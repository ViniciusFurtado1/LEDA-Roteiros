...
public class BSTImpl<T extends Comparable<T>> implements BST<T> {
    ...
    public void insert(BTNode<T> node, T element) {
        if (node.isEmpty()) {
    ...
    public void preOrder(BSTNode<T> node, int i, T[] array) {
        if (!node.isEmpty()) {
    ...
    public int order(BSTNode<T> node, int i, T[] array) {
        if (!node.isEmpty()) {
    ...
    public int postOrder(BSTNode<T> node, int i, T[] array) {
        if (!node.isEmpty()) {
